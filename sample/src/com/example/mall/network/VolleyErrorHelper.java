 ...
 * @FileName: com.example.mall.network.VolleyErrorHelper.java
 * @author: liqiongwei
 * @date: 2015-09-06 15:50
 */
public class VolleyErrorHelper {
    ...
    public static String getMessage(Object error, Context context) {
        ...
        } else if (isJsonSyntaxException(error)) {
     ...
     * @return
     */
    private static boolean isJsonSyntaxException(Object error) {
